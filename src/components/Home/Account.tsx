    ...
    <div id="account" className='bg-[#0F0F0F] min-h-[50dvh] rounded-xl'>
      <div className='py-8 px-5'>
        ...
        <div>
          ...
          <input type={inputInformationType} className='w-full border-none outline-none font-bold text-base text-white' value="R$ 750,00" readOnly />
        </div>
        <div className='mt-8 bg-[#4E0578] w-[180px] h-[180px] rounded-full flex items-center justify-center hover:brightness-125 transition ease-in-out cursor-pointer'>
          <div className='bg-[#2C2C2C] w-[130px] h-[130px] border-[10px] border-[#000] rounded-full flex flex-col items-center justify-center'>
            ...
            <input type={inputInformationType} className='w-full border-none outline-none font-bold text-base text-white text-center' value="R$ 450,00" readOnly />
          </div>
        </div>
        <div className='mt-7'>
          <ul className='space-y-2'>
            <li className='flex justify-between items-center'>
              ...
              <input type={inputInformationType} className='w-[35%] border-none outline-none font-bold text-base text-white' value="R$ 750,00" />
            </li>
            <li className='flex justify-between items-center'>
              ...
              <input type={inputInformationType} className='w-[35%] border-none outline-none font-bold text-base text-white' value="R$ 450,00" />
            </li>
            <li className='mt-10'>
