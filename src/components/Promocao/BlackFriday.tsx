...
export default function BlackFriday() {
  return (
    <div id="black-friday" className="w-[99%] mt-10 grid grid-cols-2 gap-5 items-stretch">
      <div className="opacity-0 animate-down 2xl:h-full bg-[#ECECEC] rounded relative overflow-hidden hover:-translate-y-5 hover:brightness-105 cursor-pointer transition ease-in-out" style={{ animationDelay: "0.72s " }}>
      ...
      <div className="opacity-0 animate-up 2xl:h-full bg-[#ECECEC] rounded relative overflow-hidden hover:-translate-y-5 hover:brightness-105 cursor-pointer transition ease-in-out" style={{ animationDelay: "0.92s " }}>
        <div className="grid grid-cols-[auto_1fr] h-full">
          <div className="h-full relative z-10 p-3 2xl:p-5">
            <div className="flex gap-3">
