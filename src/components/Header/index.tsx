    ...
    <header className='bg-[rgba(46,_5,_75,_0.6)] p-5 flex justify-between items-center'>
      ...
      <nav>
        <ul className='flex items-center gap-5'>
          <li className='bg-[#4E0578] py-1.5 px-2 rounded-xl flex items-center justify-around gap-3 relative min-h-[70px]'>
          ...
          <li className='bg-[#421D5D] py-1.5 px-2.5 flex items-center rounded-full min-h-[70px] gap-2'>
          ...
          <li className='bg-[#421D5D] flex items-center justify-center rounded-full w-[70px] h-[70px]'>
