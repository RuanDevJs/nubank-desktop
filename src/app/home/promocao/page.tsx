        ...
        <div className="grid grid-cols-8 items-start mt-5 gap-2">
          <div>
            <div className="bg-[rgba(208,_80,_165,_1)] w-full h-28 rounded flex items-center justify-center overflow-hidden">
              <Image src={Presente} alt="" width={100} height={100} quality={80} className="object-cover overflow-hidden" />
            </div>
          ...
          <div>
            <div className="bg-[#4D86B1] w-full h-28 rounded flex items-center justify-center overflow-hidden">
              <Image src={Smartphone} alt="" width={100} height={100} quality={80} className="object-cover overflow-hidden ml-7" />
            </div>
          ...
          <div>
            <div className="bg-[#7A76D4] w-full h-28 rounded flex items-center justify-center overflow-hidden">
              <Image src={MaquinaDeLavar} alt="" width={100} height={100} quality={80} className="object-cover overflow-hidden ml-4 mt-2" />
            </div>
            <h3 className="font-medium text-sm text-zinc-200 text-center mt-2">Eletro-domésticos</h3>
          </div>
          <div>
            <div className="bg-[#4D86B1] w-full h-28 rounded flex items-center justify-center overflow-hidden">
              <Image src={ControleDualSense} alt="" width={100} height={100} quality={80} className="object-cover overflow-hidden" />
            </div>
          ...
          <div>
            <div className="bg-[#49ABB4] w-full h-28 rounded flex items-center justify-center overflow-hidden">
              <Image src={Televisão} alt="" width={100} height={100} quality={80} className="object-cover overflow-hidden" />
            </div>
          ...
          <div>
            <div className="bg-[#7A76D6] w-full h-28 rounded flex items-center justify-center overflow-hidden">
              <Image src={Liquidificador} alt="" width={100} height={100} quality={80} className="object-cover overflow-hidden" />
            </div>
            <h3 className="font-medium text-sm text-zinc-200 text-center mt-2">Eletro-portáteis</h3>
          </div>
          <div>
            <div className="bg-[#4D86B1] w-full h-28 rounded flex items-center justify-center overflow-hidden">
              <Image src={Mala} alt="" width={100} height={100} quality={80} className="object-cover overflow-hidden" />
            </div>
          ...
          <div>
            <div className="bg-[#481571] w-full h-28 rounded flex items-center justify-center overflow-hidden">
              <Image src={Notebook} alt="" width={100} height={100} quality={80} className="object-cover overflow-hidden" />
            </div>
